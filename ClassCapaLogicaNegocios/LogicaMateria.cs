...
namespace ClassCapaLogicaNegocios
{
    public class LogicaMateria
    {
        ...
        public Boolean InsertarMateria(EntidadMateria entidadMateria, ref string mensajeSalida)
        {
        ...
        public DataTable ObtenerMateriasGrid(ref string msj_salida)
        {

            string query = "select id_Materia as Codigo, NombeMateria as Nombre, HorasSemana as Horas_por_semana, Extra from Materia";
        ...
        public string EliminarMateria(string id, ref string mensajeSalida)
        {
        ...
        public List<EntidadMateria> ObtenerMateriaPorID(string id, ref string msj_salida)
        {
        ...
        public string ModificarMateriaPorId(string id, EntidadMateria entidad, ref string mensajeSalida)
        {
            SqlParameter[] parametros = new SqlParameter[1];
            parametros[0] = new SqlParameter
            {
